...
Se le pendenze fossero uguali, averne tre sarebbe un esercizio. Non lo sono, ed
è questo il capitolo che lo mostra.
...
Lo stesso vale per la composizione dell'ingresso:

\begin{center}
\includegraphics[width=0.92\textwidth]{../result/scaling_descriptor_insns.pdf}
\end{center}

Cambiare \emph{quali} feature compongono il vettore d'ingresso ricompila P1;
P2 e P3 leggono il descrittore da una tabella e non cambiano di una istruzione.
(Barre e non linee: una linea fra due nomi disegnerebbe una pendenza che non
esiste.)
